...
class _BoardScreenState extends State<BoardScreen> with WidgetsBindingObserver {
  ...
  void didChangeAppLifecycleState(AppLifecycleState state) {
    // Ketika aplikasi di-resume (kembali dari background)
    if (state == AppLifecycleState.resumed) {
      // Pastikan keyboard tidak muncul otomatis
      searchFocusNode.unfocus();
    }
  }

  // Tambahkan fungsi ini untuk memastikan keyboard tidak muncul
  ...
  Widget build(BuildContext context) {
    ...
    return PopScope(
      onPopInvoked: (didPop) {
        _clearSearchFocus(); // Pastikan keyboard tidak muncul saat kembali
      },
                  ...
                  Consumer<BoardViewModel>(
                    builder: (context, viewModel, child) {
                      return customTextFormField(
                        ...
                        focusNode: searchFocusNode, // Gunakan focusNode di sini
                        labelText: "Pencarian",
                        prefixIcon: const Icon(Icons.search),
                        autofocus: false, // Pastikan tidak auto fokus
                        onChanged: (value) {
                        ...
                        suffixIcon: viewModel.searchQuery.isNotEmpty
                            ? IconButton(
                                ...
                                onPressed: () {
                                  ...
                                  _clearSearchFocus(); // Hapus fokus saat clear search
                                },
                              )
                            : null,
                      );
                              ...
                              child: customCardBoard(
                                  ...
                                  onTap: (value) async {
                                    if (value == 'edit') {
                                      ...
                                      selectedVisibility = boardViewModel
                                          .selectedBoardVisibility;
                                      boardViewModel.judulBoard.text =
                                          board.name;
