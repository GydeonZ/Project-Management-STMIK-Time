...
import 'package:projectmanagementstmiktime/model/model_forgot_password.dart';
...
class ForgotPasswordService {
  ...
  Future<ModelForgotPassword?> forgotPasswordUser({
    ...
    try {
      ...
      if (response.statusCode == 200) {
        return ModelForgotPassword.fromJson(response.data);
